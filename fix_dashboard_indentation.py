...
# -*- coding: utf-8 -*-
"""
Script pour corriger l'erreur d'indentation dans dashboard.py
"""
import os
...
class Dashboard(ttk.Frame):
    ...
    def _load_department_frame(self, parent):
        ...
        try:
            ...
            self.after(100, lambda: self._upgrade_comboboxes(self.dept_frame))
        except Exception as e:
    ...
    def _upgrade_comboboxes(self, parent=None):
        """Remplace les combobox standards par les améliorés"""
        if parent is None:
            parent = self
...
if __name__ == "__main__":
    print("Correction de l'erreur d'indentation dans dashboard.py...")
    replace_dashboard()
